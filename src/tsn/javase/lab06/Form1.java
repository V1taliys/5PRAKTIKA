...
public class Form1 extends javax.swing.JFrame {
    ...
    public class MyPicture extends JPanel { // КЛАСС РИСОВАНИЯ СВОЕЙ КАРТИНКИ
        ...
        MyPicture() {
            ...
            canvas.drawArc(145, 105, 45, 40, 180, 180); // Отрисовываем дугу по середине овала
            canvas.drawArc(100, 105, 45, 40, 0, 180);
            //рисуем два мелньких круга сверху и снизу
            canvas.drawOval(118, 120, 12, 12);
            canvas.drawOval(162, 120, 12, 12);
            //устанавливаем стиль и пишим текст
            canvas.setPaint(Color.RED);
            canvas.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 33));
            canvas.drawString("Федоренко В.С.!", 5, 50);

            try {
                // При помощи созданной функции заливки закрашиваем две части главного овала
                // и два маленьких кружка
                fill(110, 110, Color.GRAY, Color.BLACK);
                fill(162, 120, Color.GRAY, Color.WHITE);
                fill(165, 125, Color.GRAY, Color.BLACK);
                fill(120, 125, Color.GRAY, Color.WHITE);
            } catch (Exception ex) {
            }
        }
